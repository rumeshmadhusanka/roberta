...
from allennlp.training.metrics import ROUGE, BLEU, BooleanAccuracy, Average, F1Measure
import pdb

from models.race_partial_accuracy import Self_Accuracy

@Model.register("t5-customized")
class T5(Model):
    ...
    def forward(  # type: ignore
        ...
        if self.training:
            ...
            # output_dict["predictions"] = output.predictions[:, 0, :labels.shape[1]]
            # Shape: (batch_size, )
    ...
    def get_metrics(self, reset: bool = False) -> Dict[str, float]:
        ...
        if not self.training:
            ...
            metrics["self_accuracy"] = self._metrics[2].get_metric(reset=reset)
